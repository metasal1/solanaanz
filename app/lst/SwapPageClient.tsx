            ...
            {!connected ? (
              <>
                ...
                <div className="flex justify-center">
                  <WalletMultiButton className="!bg-gradient-to-r !from-blue-600 !to-purple-600 hover:!from-blue-700 hover:!to-purple-700 !rounded-lg !font-semibold !px-8 !py-4" />
                </div>
              </>
            ) : (
              <>
                <Button
                  onClick={() => {
                    ...
                    alert('Swap functionality coming soon! Use Sanctum directly for now.');
                  }}
                  disabled={!quote || quoteLoading || !amount || parseFloat(amount) <= 0}
                  className="w-full py-4 px-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-lg font-semibold"
                >
                  Swap Now
                </Button>
                <div className="flex justify-center">
                  <WalletMultiButton className="!bg-gray-100 dark:!bg-gray-800 !text-gray-900 dark:!text-white hover:!bg-gray-200 dark:hover:!bg-gray-700 !rounded-lg !font-medium !px-6 !py-2 !text-sm" />
                </div>
              </>
            )}
          </div>
